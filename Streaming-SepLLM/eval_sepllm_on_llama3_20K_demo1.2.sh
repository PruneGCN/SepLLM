CUDA_VISIBLE_DEVICES=0  python ./main/evaluate_streaming_inputs_perplexity.py \
    ...
    --task default \
    --split test\
    --output_dir ./outputs/demo/llama3_8b_sepllm_len20480_ca800_loc256_sep32_init4_pg19_demo   2>&1 | tee ./logs/demo/llama3_8b_sepllm_len20480_ca800_loc256_sep32_init4_pg19_demo.log
