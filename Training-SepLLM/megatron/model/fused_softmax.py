...
class FusedScaleMaskSoftmax(nn.Module):
    ...
    def forward(self, input, mask):
        # [b, np, sq, sk]
        assert input.dim() == 4
        if self.is_kernel_available(mask, *input.size()):  ## my Pythia default=True  when self.upper_triang_mask_fusion: False. slef.general_mask_fusion: True
            # print(f"Debug: #############is_kernel_available: True#####################") ##my
            return self.forward_fused_softmax(input, mask)
        else:
            # print(f"Debug: #############is_kernel_available: False#####################") ##my
    ...
    def forward_fused_softmax(self, input, mask):
        ...
        if self.upper_triang_mask_fusion:              
            ...
            # ###############################################my Debug#################################################
            # print(f"Debug: #############self.upper_triang_mask_fusion: {self.upper_triang_mask_fusion}. self.general_mask_fusion: {self.general_mask_fusion} #####################") ##my
            # self.upper_triang_mask_fusion: False. slef.general_mask_fusion: True
            # ########################################################################################################     
