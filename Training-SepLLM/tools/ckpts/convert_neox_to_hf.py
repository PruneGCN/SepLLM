...
# from transformers.models.gpt_neox import  SepLLMGPTNeoXConfig
...
MODEL_KEYS["sepllm_gpt_neox"] = MODEL_KEYS["neox"]
...
def create_config(neox_config, architecture="sepllm_gpt_neox"):
    ...
    print(f"debug###############################at 1st neox_config: {neox_config}#########################################")
    ...
    args = {
        ...
        "prefill_local_window_size": get_key(neox_config, "prefill_local_window_size", 256),
        "generate_local_window_size": get_key(neox_config, "generate_local_window_size", 256),
        ...
        "prefill_loc_win_size_list": get_key(neox_config, "prefill_loc_win_size_list", [2048,  256,  256,  256,  256,  2048,  256,  256,  256, 256, 256,  2048 ]),
        "generate_win_loc_size_list": get_key(neox_config, "generate_win_loc_size_list", [2048,  256,  256,  256,  256,  2048,  256,  256,  256, 256, 256,  2048 ]),
        ...
        "print_ratio_intervals": get_key(neox_config, "print_ratio_intervals", 4000),
        "USE_SEP_ATTN_KERNEL_ACCELERATOR": get_key(neox_config, "USE_SEP_ATTN_KERNEL_ACCELERATOR", False),
        "RECOMPILE_SEP_ATTN_KERNEL": get_key(neox_config, "RECOMPILE_SEP_ATTN_KERNEL", False),  
        "_DEFAULT_SPARSE_BLOCK_SIZE": get_key(neox_config, "_DEFAULT_SPARSE_BLOCK_SIZE", 128),  
